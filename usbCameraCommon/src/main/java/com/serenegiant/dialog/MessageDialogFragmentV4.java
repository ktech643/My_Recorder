...
//	private static final boolean DEBUG = false;	// FIXME 実働時はfalseにすること
	...
	public static MessageDialogFragmentV4 showDialog(final androidx.fragment.app.Fragment parent, final int requestCode, final int id_title, final int id_message, final String[] permissions) {
		final MessageDialogFragmentV4 dialog = newInstance(requestCode, id_title, id_message, permissions);
