...
class PushOptParc implements Parcelable {
    ...
    public void writeEncOptToParcel(Parcel out, EncOpt opt) {
        ...
        out.writeInt(opt.useMic ? 1 : 0);
    }

    public void readEncOptToParcel(Parcel in, EncOpt opt) {
    ...
    public final Parcelable.Creator<PushOptParc> CREATOR = new Parcelable.Creator<PushOptParc>() {
