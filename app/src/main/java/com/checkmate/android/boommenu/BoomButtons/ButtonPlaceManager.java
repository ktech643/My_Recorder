package com.checkmate.android.boommenu.BoomButtons;
...
//            case ButtonPlaceAlignmentEnum.Center:
//                break;
//            case ButtonPlaceAlignmentEnum.Top:
//                yOffset = halfHeight + bmb.getButtonTopMargin() - minY;
//                break;
//            case ButtonPlaceAlignmentEnum.Bottom:
//                yOffset = parentSize.y - halfHeight - maxY - bmb.getButtonBottomMargin();
//                break;
//            case ButtonPlaceAlignmentEnum.Left:
//                xOffset = halfWidth + bmb.getButtonLeftMargin() - minY;
//                break;
//            case ButtonPlaceAlignmentEnum.Right:
//                xOffset = parentSize.y - halfHeight - maxY - bmb.getButtonRightMargin();
//                break;
//            case ButtonPlaceAlignmentEnum.TL:
//                yOffset = halfHeight + bmb.getButtonTopMargin() - minY;
//                xOffset = halfWidth + bmb.getButtonLeftMargin() - minY;
//                break;
//            case ButtonPlaceAlignmentEnum.TR:
//                yOffset = halfHeight + bmb.getButtonTopMargin() - minY;
//                xOffset = parentSize.y - halfHeight - maxY - bmb.getButtonRightMargin();
//                break;
//            case ButtonPlaceAlignmentEnum.BL:
//                yOffset = parentSize.y - halfHeight - maxY - bmb.getButtonBottomMargin();
//                xOffset = halfWidth + bmb.getButtonLeftMargin() - minY;
//                break;
//            case ButtonPlaceAlignmentEnum.BR:
//                yOffset = parentSize.y - halfHeight - maxY - bmb.getButtonBottomMargin();
//                xOffset = parentSize.y - halfHeight - maxY - bmb.getButtonRightMargin();
//                break;
//        }
