...
public class BgAudioService extends BaseBackgroundService {
    ...
    private final HandlerThread mCameraThread = new HandlerThread("BgAudio");
    ...
    public static class AudioBinder extends ServiceBinder<BgAudioService> {
        public AudioBinder(BgAudioService service) {
            super(service);
        }
    }
    private WeakReference<BgAudioService.AudioBinder> mBinderRef = new WeakReference<>(new BgAudioService.AudioBinder(this));
    @Override
            ...
            public void onEglReady() {
                if (mEglManager != null) {
                    ...
                    if (sharedViewModel != null) {
                        ...
                        mEglManager.setPreviewSurface(dsurfaceTexture, 1280, 720);
                    }
    ...
    public void onDestroy() {
        ...
        if (mNotifyCallback != null) {
            mNotifyCallback.stopService(ServiceType.BgAudio);
    ...
    private void initCamera() {
        ...
        mCameraHandler.post(() -> {
            try {
                String cameraId = AppConstant.REAR_CAMERA;
