...
import com.checkmate.android.databinding.DialogOtcBinding;

public class OTCDialog extends Dialog {

    private DialogOtcBinding binding;

    public OTCDialog(Context context, int theme) {
        super(context, theme);
        // TODO Auto-generated constructor stub
        init(context);
    }

    public OTCDialog(Context context) {
        super(context);
        // TODO Auto-generated constructor stub
        init(context);
    }
    ...
    private void init(Context context) {
        ...
        binding = DialogOtcBinding.inflate(getLayoutInflater());
