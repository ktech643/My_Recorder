...
public class RePasswordDialog extends Dialog {
    ...
    public EditText edt_repassword;

    public RePasswordDialog(Context context, int theme) {
        super(context, theme);
        // TODO Auto-generated constructor stub
        init(context);
    }

    public RePasswordDialog(Context context) {
        super(context);
        // TODO Auto-generated constructor stub
        init(context);
    }
