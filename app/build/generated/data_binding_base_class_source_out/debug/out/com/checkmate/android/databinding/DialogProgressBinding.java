...
public final class DialogProgressBinding implements ViewBinding {
  ...
  private DialogProgressBinding(@NonNull LinearLayout rootView, @NonNull ProgressBar progressBar1) {
  ...
  public static DialogProgressBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogProgressBinding((LinearLayout) rootView, progressBar1);
    }
